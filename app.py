...
# --- 1. CONFIG & STYLE (ตัวหนังสือไม่ทับซ้อน & Clean Look) ---
...
<style>
    ...
    /* โหมดเจ้าของบ้าน - สีมาตรฐาน ไม่มีฉากหลัง */
    .owner-content { 
...
# --- 2. ENGINE (BHOON KHARN AI - Stable Version) ---
def init_ai_engine():
    ...
    try:
        ...
        # ใช้รุ่น Flash เป็นหลักเพื่อความเสถียร
...
def run_analysis():
    ...
    with st.spinner("BHOON KHARN AI กำลังวิเคราะห์..."):
        try:
            # ปรับ Prompt ให้ครอบคลุมงานปัจจุบันและสิ่งที่ควรระวังในอนาคต
...
if st.session_state.rep:
    ...
    sections = [
        ...
        ("🏠 สิ่งที่เจ้าของบ้านต้องทราบ (รวมงานต่อเนื่อง)", "[OWNER_NOTE]")
    ]
